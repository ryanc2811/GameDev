...
namespace GameEngine
{
    ...
    public class Kernel : Game
    {
        ...
        {
            Queue<string> PrinterJobs = new Queue<string>();
            Stack<string> Books = new Stack<string>();

            PrinterJobs.Enqueue("Job1");
            PrinterJobs.Enqueue("Job2");
            PrinterJobs.Enqueue("Job3");

            Books.Push("Book1");
            Books.Push("Book2");
            Books.Push("Book3");
            Console.WriteLine(Books.Pop());
            Console.WriteLine(PrinterJobs.Dequeue());
