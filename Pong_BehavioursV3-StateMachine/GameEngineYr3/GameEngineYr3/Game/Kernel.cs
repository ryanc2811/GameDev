...
namespace GameEngine.Kernel
{
    ...
    public class Kernel : Game
    {
        ...
        private IAIComponent characterAI;
        ...
        void InstantiateMembers()
        {
            ...
            characterAI = componentManager.Create<TopDownCharacterAI>();
        ...
        protected override void Initialize()
        {
            ...
            inputManager.addEventListener(InputDevice.Keyboard, ((IInputListener)characterAI).OnNewInput);
            ...
            characterAI.SetAIUser((IAIUser)character);
