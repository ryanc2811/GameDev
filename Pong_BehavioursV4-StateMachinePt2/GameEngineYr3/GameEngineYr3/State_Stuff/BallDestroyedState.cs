...
{
    class BallDestroyedState : BaseState, IStateWithCollision, IStateWithInput
    {
        ...
        public override void SetTransitions()
        {
            ...
            {
                new Transition("DestroyedToServe",new RestartBall(),
                (int)BallState.Serve, StateIndex(),0)
            };
        }
        /// <summary>
        ...
        {
            return (int)BallState.Destroyed;
        }
    }
}
