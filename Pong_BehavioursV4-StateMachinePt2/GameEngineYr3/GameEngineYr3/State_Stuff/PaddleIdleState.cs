...
{
    class PaddleIdleState:BaseState, IStateWithInput, IStateWithCollision
    {//DECLARE an Action for handling the input event
        ...
        public override void SetTransitions()
        {
            ...
            {
                new Transition("IdleToMove",new PaddleMoved(),
                (int)PaddleState.Move, StateIndex(),0)
            };
        }
        /// <summary>
